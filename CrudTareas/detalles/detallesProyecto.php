...
<div class="row"> 
    ...
    <div class="col-12 d-flex justify-content-center align-items-center" style="margin-top: 100px;">
        <form action="../actualizar/actualizarProyec.php" method="POST"  style="background-color: rgba(58, 61, 60, 0.8); height: 470px; width: 300px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
            <?php
                foreach ($query1 as $proyectos){
                    echo '<div style="color: white; "class="mb-3">
                        ...
                        <div style="color: white;" class="mb-3">
                            ...
                            <input type="text" class="form-control" id="idCoord" name="idCoord" value="'.$proyectos->idCoord.'" >
                        </div>'
                        ;     
                }
            ?>
            ...
            <div style="color: white; margin-top: 10px; display: flex; justify-content: space-between;" class="row">
                <div class="col-4">
                    <?php 
                        if($_SESSION['cargo'] == 1) {
                            ?>
                            <button type="button" class="btn btn-outline-dark text-white" onclick="location.href='../tablas/tablaProyectos.php'">Atras</button>
                            <?php
                        }?>
                </div>
