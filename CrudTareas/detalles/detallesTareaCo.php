...
<div class="row"> 
    ...
    <div class="col-12 d-flex justify-content-center align-items-center" style="margin-top: 100px;">
        <form action="..\actualizar\actualizarTareaCo.php" method="POST"  style="background-color: rgba(58, 61, 60, 0.8); height: auto; width: 300px; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 20px; ">
            <?php
