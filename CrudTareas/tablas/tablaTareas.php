<?php
    ...
    b.idUsuario as idUsuario
     FROM tareas a ,usuariosTarea b 
     WHERE a.idTarea = b.idTarea 
                ...
                <tbody>
                    ...
                    if ($resultado->rowCount() > 0){
                        while ($fila=$resultado->fetch(PDO::FETCH_ASSOC)){
                            ...
                            echo '<form action="../detalles/detallesTarea.php" method="POST">';
                            ...
                            echo '</form>';
                            echo '<form action="../eliminar/eliminarTarea.php" method="POST">';
                            echo '<input type="hidden" name="idTarea" id="codigo" value="'.$fila['idTarea'].'"/>';
                ...
                if (isset($_GET['pagina'])){
                        if ($_GET['pagina'] > 1) {
                            echo '<li class="page-item">
                                    <a class="page-link" href="tablaTareas.php?pagina='. ($_GET['pagina'] - 1) .'" arial-label="Previous>
                      ...
                      for ($i=1; $i <=$cantidadPaginas; $i++){
                        if ($_GET['pagina'] == $i) {
                            ...
                            echo '<li class="page-item disabled"><a class="page-link" href="tablaTareas.php?pagina='.$i.'">'.$i.'</a></li>';
                        } else {
                            echo '<li class="page-item"><a class="page-link" href="tablaTareas.php?pagina='.$i.'">'.$i.'</a></li>';;
                        }
                        ...
                        if ((($_GET['pagina']) * $productosPorPagina) < $maximoElementos) {
                            echo '<li class="page-item">
                                    <a class="page-link" href="tablaTareas.php?pagina='. ($_GET['pagina'] + 1) .'" aria-label="Next">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content bg-dark text-white">
                            ...
                            <div class="modal-body">
                                <form action="../registrar/registrarTarea.php" method="POST">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="idProyecto" name="idProyecto" required>
                                    </div>
                                    <div class="mb-3">
